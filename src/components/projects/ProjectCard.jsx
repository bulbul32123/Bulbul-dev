            ...
            <motion.div initial='hidden'
                ...
                <Tilt options={{
                    ...
                    <div className="bg-gray-700 bg-opacity-40 p-6  rounded-lg">
                        ...
                        <div className="flexBetween h-full w-full mt-2 text-gray-400">
                            <span className='flex items-center max-sm:text-xs gap-1 hover:text-white'><IoEye size={20} />{item.views}</span>

                            <span className='flex items-center  max-sm:text-xs gap-1 hover:text-white'><FaComment size={20} />{item.comments}</span>
                        </div>
                    </div>
                </Tilt>
            </motion.div>
